...
const processSteps = [
    ...
    { 
        id: 4, 
        title: 'INSTALLATION', 
        description: 'Professional installation by certified Everlast teams.', 
    ...
    { 
        id: 5, 
        title: 'AFTERSALES', 
        description: 'Comprehensive aftersales support and service guarantees.', 
    ...
    return (
        <div className="flex relative">
            ...
            <div className="flex flex-col text-3xlitems-center mr-4">
                ...
                {/* Ligne verticale */}
                {step.id < 5 && <div className="h-full w-0.5 bg-gray-300 absolute top-7 ml-3"></div>}
            </div>
