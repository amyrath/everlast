...
const footerLinks = {
    // MISE À JOUR : Ajout de Fixed, Asymmetrical, et Tilt & Slide Doors
    products: [
        { name: 'Sliding Windows', href: '/product-detail/windows/1' },
        { name: 'Casement Windows', href: '/product-detail/windows/2' },
        { name: 'Fixed Windows', href: '/product-detail/windows/3' }, // Ajout
        { name: 'Asymmetrical Windows', href: '/product-detail/windows/4' }, // Ajout
        { name: 'Sliding Doors', href: '/product-detail/doors/1' },
        { name: 'Turn Doors', href: '/product-detail/doors/3' },
        { name: 'Tilt & Slide Doors', href: '/product-detail/doors/2' }, // Ajout
    ],
    company: [
        { name: 'Home', href: '/' }, 
            ...
            <div className="container mx-auto px-4 max-w-7xl">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8 border-b border-blue-700 pb-2 mb-6">
                    ...
                    <div className="col-span-1 md:col-span-1">
                        ...
                        <p className="mt-4 text-sm text-with leading-relaxed">
