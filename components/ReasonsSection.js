...
const reasonsData = [
  ...
  },
  {
    ...
    detail:
      "Everlast Windows and Doors are multi-chambered and reinforced with steel; they can withstand heavy wind loads.",
  },
  {
    id: "aesthetics",
    title: "Aesthetics",
    ...
    detail:
      "Everlast Windows and Doors have elegant looks, available in three basic and laminated colors, enhances both, the exteriors and interiors of the building.",
  },
];
// ------------------------------------------
...
const ReasonsSection = () => {
  ...
  const IconComponent =
    LucideIcons[activeDetail.icon] || LucideIcons.HelpCircle;
        ...
        <div className="flex flex-col lg:flex-row gap-12">
            ...
            {reasonsData.map((reason) => {
              ...
              return (
                <button
                  ...
                  className={`w-full text-left py-4 px-4 mb-3 rounded-lg transition-all duration-300 flex items-center gap-4 ${
                ...
                >
                  ...
                  {NavIcon && <NavIcon size={28} className="flex-shrink-0" />}

                  {/* ✅ Miniature image à droite du titre */}
                  <div className="flex items-center gap-3">
                    <span className="text-xl font-titre font-bold">
          ...
          <div className="lg:w-2/3 bg-gray-50 p-10 rounded-xl shadow-2xl text-gray-900 flex flex-col md:flex-row gap-10 items-stretch">
            ...
            <div className="md:w-2/5 flex flex-col justify-between flex-grow">
              <div>
                <h3 className="font-titre text-5xl font-bold text-blue-900">
                  {activeDetail.title}
                </h3>
              </div>
              <p className="font-corps text-gray-700 text-2xl mt-8 leading-relaxed flex-grow">
                {activeDetail.detail}
              </p>
              <a
                href="/contact"
                className="mt-8 inline-block text-red-700 text-2xl font-bold hover:underline transition duration-300"
              >
            ...
            {/* Image à droite */}
            <div className="md:w-2/5 flex items-center justify-center bg-gray-200 rounded-xl p-8 min-h-[400px]">
              {activeDetail.image ? (
                <Image
                  ...
                  width={300}
                  height={300}
                  className="rounded-lg object-contain shadow-lg hover:scale-105 transition-transform duration-300"
                />
              ) : (
                IconComponent && (
                  <IconComponent
...
//     { id: 'aesthetics', title: 'Aesthetics', icon: 'Star', detail: "Everlast Windows and Doors have elegant looks, available in three basic and laminated colors, enhances both, the exteriors and interiors of the building." },
// ];
// // ------------------------------------------
